...
public class NavigatorTablet extends Navigator {

    public NavigatorTablet(FragmentManager fragmentManager, Navigation navigation) {
    ...
    public void launchTest(CopyInstructions copy, int topicColor, List<Question> questions, boolean isResultMode, Map<String, Integer> answers, int mainBackgroundColor) {
        ...
        // leave only first fragment - instruction
        ...
        launch(examFragment, ExamFragment.class.getCanonicalName(), R.id.container_exam);
